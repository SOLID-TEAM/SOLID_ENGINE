...
void W_Scene::GridMenu()
{
	...
	ImGui::Title("Color", 2);		ImGui::ColorEdit4("##grid_clor", App->test->main_grid->color.ptr(), ImGuiColorEditFlags_Float | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel);
