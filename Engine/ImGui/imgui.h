...
struct ImDrawList;                  // A single draw command list (generally one per window, conceptually you may see this as a dynamic "data" builder)
...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginComboEx(const char* label, const char* preview_value, float width , ImGuiComboFlags flags = 0);
