...
void Primitive::GenBuffer()
{
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(unsigned short) * mesh->ntriangles * 3, &mesh->triangles[0], GL_STATIC_DRAW);
}
...
void Primitive::Render()
{
	...
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, elements_id);
	glDrawElements(GL_TRIANGLES, mesh->ntriangles * 3, GL_UNSIGNED_SHORT, (void*)0);
