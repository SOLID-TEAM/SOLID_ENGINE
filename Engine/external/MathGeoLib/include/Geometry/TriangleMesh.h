...
/// Represents an unindiced triangle data.
/** This class stores a triangle data as flat array, optimized for ray intersections. */
class TriangleMesh
{
public:
	TriangleMesh();
	...
	/// Specifies the vertex data of this triangle data. Replaces any old
	/// specified geometry.
