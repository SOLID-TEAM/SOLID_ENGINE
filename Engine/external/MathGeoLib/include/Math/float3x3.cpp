...
{
	assume(p.PassesThroughOrigin() && "A 3x3 matrix cannot represent mirroring show_about_popup planes which do not pass through the origin! Use float3x4::Mirror instead!");
	float3x3 v;
